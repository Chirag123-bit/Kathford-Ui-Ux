...
// // First The program thinks of a nunber between 1-10
// // Asks user for a number
// // Matches user's Guess with the original Number
// // Allows for three tries
// // Success Or False, Depending on the match

// let variable = 10.35;
// console.log(Math.round(variable));
// console.log(Math.floor(variable));
// console.log(Math.ceil(variable));
...
function numberGuessingGame() {
  ...
  while (lives > 0 && !guess) {
    ...
    if (userGuess == number) {
      console.log("Congraluations! You are correct");
      guess = true;
    } else {
